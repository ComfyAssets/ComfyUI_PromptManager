...
class PromptManager(ComfyNodeABC):
    ...
    OUTPUT_TOOLTIPS = (
        ...
        "The original text prompt as a string output for chaining to other nodes."
    )
    FUNCTION = "encode"
    ...
    def encode(
        ...
        Returns:
            Tuple containing the conditioning for the diffusion model and the original text string
