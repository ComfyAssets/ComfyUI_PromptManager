...
try:  # pragma: no cover - validation import path differs in tests
    from ..validation.file_ops import AtomicWriter, BatchFileOperation  # type: ignore
except ImportError:  # pragma: no cover
    from utils.validation.file_ops import AtomicWriter, BatchFileOperation  # type: ignore
...
def _get_image_base_dir() -> Path:
    """Get the base directory for image processing using ComfyUI root detection."""
...
class ThumbnailGenerator:
    ...
    def __init__(self, cache_dir: Union[str, Path] = None):
        ...
        """
        self.cache_dir = Path(cache_dir) if cache_dir else _get_image_base_dir() / '.thumbnails'
    ...
    def clear_cache(self, older_than_days: Optional[int] = None):
        ...
        """
        from utils.validation.file_ops import FileCleanup
