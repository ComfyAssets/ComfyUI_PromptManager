...
try:  # pragma: no cover - validation import path differs in tests
    from ..validation.file_ops import AtomicWriter  # type: ignore
except ImportError:  # pragma: no cover
    from utils.validation.file_ops import AtomicWriter  # type: ignore
...
def _get_performance_base_dir() -> Path:
    """Get the base directory for performance data using ComfyUI root detection."""
...
class PerformanceMonitor:
    ...
    def __init__(self):
        ...
        if not hasattr(self, '_initialized'):
            ...
            self._save_path = _get_performance_base_dir() / 'performance_metrics.json'
